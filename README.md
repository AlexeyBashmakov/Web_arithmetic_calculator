...
### Консоль
Для проверки работы проекта из консоли необходимо запустить ещё одну консоль. Работа с сервисом в консоли отличается для операционных систем Windows и Linux.
